...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Modelled a 3D cantilever beam under tip load in ABAQUS, ran a mesh-sensitivity study, and quantified the numerical artefacts of shear locking and hourglassing to establish exactly when the computed stress field can be trusted.",
